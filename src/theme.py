"""Tema e CSS global do painel.

Extraído de monitoramento_V3.py (Fase 2 da modularização).
O conteúdo do CSS foi preservado byte-a-byte; apenas indentado dentro da função.
"""
...
def injetar_css_global() -> None:
    """Injeta os dois blocos de CSS global (tema Bento claro moderno)."""
    st.markdown("""
    <style>
